...
function SCT:MakeBlizzOptions()
  ...
  RegisterAddOnCategory(SCTOptions_EventsFrame, SCTOptions_EventsFrame.name, SCTOptions_EventsFrame.parent)
  ...
  RegisterAddOnCategory(SCTOptions_FramesFrame, SCTOptions_FramesFrame.name, SCTOptions_FramesFrame.parent)
  ...
  RegisterAddOnCategory(SCTOptions_SpellFrame, SCTOptions_SpellFrame.name, SCTOptions_SpellFrame.parent)
  ...
  RegisterAddOnCategory(SCTOptions_AnimationFrame, SCTOptions_AnimationFrame.name, SCTOptions_AnimationFrame.parent)
  ...
  RegisterAddOnCategory(SCTOptions_CustomEventsFrame, SCTOptions_CustomEventsFrame.name, SCTOptions_CustomEventsFrame.parent)
  ...
  RegisterAddOnCategory(SCTOptions_SaveLoadFrame, SCTOptions_SaveLoadFrame.name, SCTOptions_SaveLoadFrame.parent)

  ExpandAddOnCategory("SCT")
end
